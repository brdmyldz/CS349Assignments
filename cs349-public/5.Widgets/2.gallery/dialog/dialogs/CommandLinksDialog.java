...
public class CommandLinksDialog extends Dialog<ButtonType> {
    ...
    public CommandLinksDialog(List<ButtonType> links) {
        ...
        dialogPane.setGraphic(new ImageView(new Image(getClass().getResource("dialog/dialog-information.png").toExternalForm())));
...
//        graphicContainer.getStyleClass().add("graphic-container");
        ...
        ImageView arrow = new ImageView(getClass().getResource("images/about_16.png").toExternalForm());
