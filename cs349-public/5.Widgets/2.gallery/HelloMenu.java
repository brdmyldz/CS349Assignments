...
public class HelloMenu extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        final Menu menu11 = makeMenu("_New", new ImageView(new Image("images/about_16.png")));
        MenuItem menu12 = new MenuItem("_Open", new ImageView(new Image("images/folder_16.png")));
        ...
        showMessagesItem = new CheckMenuItem("Enable onShowing/onHiding _messages",
                                             new ImageView(new Image("images/about_16.png")));
