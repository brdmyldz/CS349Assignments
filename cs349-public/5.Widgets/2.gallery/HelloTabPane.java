...
public class HelloTabPane extends Application {
    ...
    @Override public void start(Stage stage) {
...

        {
            ...
            final Image image = new Image(getClass().getResourceAsStream("images/about_16.png"));
        ...
        }
        {
            ...
            final Image image = new Image(getClass().getResourceAsStream("images/folder_16.png"));
            final ImageView imageView = new ImageView();
            imageView.setImage(image);
        ...
        {
            tab3.setText("Tab 3");
            final Image image = new Image(getClass().getResourceAsStream("images/heart_16.png"));
            final ImageView imageView = new ImageView();
            imageView.setImage(image);
            ...
            }
            {
                ...
                tb.selectedProperty().addListener(new InvalidationListener() {
                    public void invalidated(Observable ov) {
                        Image image;
                        if (tb.isSelected()) {
                            image = new Image(getClass().getResourceAsStream("images/about_48.png"));
                        } else {
                            image = new Image(getClass().getResourceAsStream("images/about_16.png"));
                        }
            ...
            }
            {
                ...
                tb.selectedProperty().addListener(new InvalidationListener() {
                    public void invalidated(Observable ov) {
                        Image image;
                        if (tb.isSelected()) {
                            image = new Image(getClass().getResourceAsStream("images/folder_48.png"));
                        } else {
                            image = new Image(getClass().getResourceAsStream("images/folder_16.png"));
                        }
                        ImageView imageView = new ImageView();
                        imageView.setImage(image);
                        tab2.setGraphic(imageView);
            ...
            }
            {
                ...
                tb.selectedProperty().addListener(new InvalidationListener() {
                    public void invalidated(Observable ov) {
                        Image image;
                        if (tb.isSelected()) {
                            image = new Image(getClass().getResourceAsStream("images/heart_48.png"));
                        } else {
                            image = new Image(getClass().getResourceAsStream("images/heart_16.png"));
                        }
                        ImageView imageView = new ImageView();
                        imageView.setImage(image);
                        tab3.setGraphic(imageView);
